...
me12[Author]
	...
	·Any loss caused by a breach of the protocol will not be borne by the author.
	·All rights reserved by the author.
	·By using this software, you agree to all the terms of the protocol.
## Model Structure
...
![Model Structure](icon/svgcc.png)

## Hardware Environment
Memory: 8G (less memory may cause OOM error)
